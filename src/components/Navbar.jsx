  ...
  const navList = (
    <ul className="mt-2 mb-4 flex   text-black flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link to="/products" className="flex text-black items-center">
          Products
        </Link>
      </Typography>
      <Typography
...
{loggedin != null ?
  ...
  return (
    <Navbar className="md:mt-3 lg:mt-10 z-50 mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        <Link to={"/"} className="flex items-center">
          ...
          <Typography
            as="a"
            href="/"
            className="mr-4 cursor-pointer flex py-1.5 font-extrabold"
          >
              SneakHub
          </Typography>
        </Link>
