...
export default function HomePage(){
    return (
        ...
        <Carousel  transition={{ duration: 1 }} className="rounded-3xl h-1/2 w-11/12 mx-auto">
        <div className="relative h-full w-full mx-auto">
            ...
            <div className="absolute inset-0 grid h-full w-full items-center bg-black/75">
              <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
                ...
                >
                  Step into style with our curated collection of trendy footwear at unbeatable prices. Elevate every stride and express your unique personality with our diverse range of shoes today!
                </Typography>
            ...
            <div className="absolute inset-0 grid h-full w-full items-end bg-black/75">
              <div className="w-3/4 pl-12 pb-12 md:w-2/4 md:pl-20 md:pb-20 lg:pl-32 lg:pb-32">
                ...
                <Typography
                  ...
                  className="mb-12 opacity-80"
                >
                  Unlock comfort and style with every step. Find your perfect pair today!
                </Typography>
                <div className="flex gap-2">
                    <Link to="/shop">
                  <Button size="lg" color="white">
            ...
            <div className="absolute inset-0 grid h-full w-full items-center bg-black/75">
              <div className="w-3/4 pl-12 md:w-2/4 md:pl-20 lg:pl-32">
                ...
                <Typography
                  ...
                  className="mb-12 opacity-80"
                >
                  From casual kicks to elegant heels, we have shoes for every occasion. Explore our collection and step into confidence!
                </Typography>
                <div className="flex gap-2">
                    <Link to="/shop">
                  <Button size="lg" color="white">
